...
"/>
  ...
  <text x="780" y="135" text-anchor="middle" font-family="'Fira Code', 'Courier New', monospace" font-size="48" font-weight="bold" fill="#FF0040" letter-spacing="4" class="glitch" opacity="0.8">
    MATHIYAZHAGAN
  </text>
  <text x="780" y="135" text-anchor="middle" font-family="'Fira Code', 'Courier New', monospace" font-size="48" font-weight="bold" fill="#FF0040" letter-spacing="4" class="glitch-red" filter="url(#glitch)">
    MATHIYAZHAGAN
  </text>

  <!-- Main title -->
  <text x="780" y="135" text-anchor="middle" font-family="'Fira Code', 'Courier New', monospace" font-size="48" font-weight="bold" fill="url(#nameGrad)" filter="url(#glowNeon)" letter-spacing="4">
    MATHIYAZHAGAN
  </text>

  <!-- Subtitle with typing effect -->
  <g>
    <text x="780" y="180" text-anchor="middle" font-family="'Fira Code', 'Courier New', monospace" font-size="15" fill="#FF4080" filter="url(#glowText)" letter-spacing="6" class="flicker">
      SILENT THUNDER
    </text>
    <text x="780" y="205" text-anchor="middle" font-family="'Fira Code', 'Courier New', monospace" font-size="14" fill="#FF2060" filter="url(#glowText)" letter-spacing="8" class="flicker">
      DEVELOPER
    </text>
    <!-- Blinking cursor -->
    <rect x="880" y="192" width="10" height="16" fill="#FF0040" class="cursor-blink" opacity="0.7"/>
  </g>

  <!-- Decorative lines -->
  <line x1="520" y1="225" x2="1040" y2="225" stroke="url(#lineGrad)" stroke-width="1" class="pulse-anim"/>

  <!-- Tagline -->
  <text x="780" y="260" text-anchor="middle" font-family="'Fira Code', 'Courier New', monospace" font-size="12" fill="#FF0040" letter-spacing="4" opacity="0.7" class="flicker">
